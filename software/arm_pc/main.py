...
class MainWindow(QtWidgets.QWidget, Ui_Form):
    def __init__(self):
        ...
        for i in range(self.joints):
            if i == 5:
                self.lineEdit_object[i].setValidator(QIntValidator(100, 700))
            elif i == 4:
                self.lineEdit_object[i].setValidator(QIntValidator(70, 930))
            else:
        ...
        self.horizontalSlider_pulse_object[5].setRange(100, 700)
        self.horizontalSlider_pulse_object[4].setRange(70, 930)
