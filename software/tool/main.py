...
class MainWindow(QWidget, ui.Ui_Form):
    def __init__(self):
        ...
        depth_camera_list = ['Dabai', 'usb_cam']
        lidar_list = ['A1', 'A2', 'G4', 'S2L', 'LD14P']
        machine_list = ['JetRover_Mecanum', 'JetRover_Tank', 'JetRover_Acker']
        language_list = ['Chinese', 'English']
        mic_type_list = ['xf', 'WonderEchoPro']
        ...
        self.lineEdit_wifi.setFocusPolicy(Qt.NoFocus)
    ...
    def get_typerc(self):
        with open(self.typerc_path, "r") as f:
            ...
            self.mic = re.findall(r'export MIC_TYPE.*?\n', data)[0].split('=')[1].replace('\n', '')
            f.close()
    ...
    def set_typerc(self):
        ...
        with open(self.typerc_path, "r") as f:
            ...
            data = data.replace("=" + self.mic, "=" + mic)
            f.close()
